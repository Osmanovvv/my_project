...
export const TEXT_DEFAULTS = {
  ...
  /* Описывать портфолио перечислением отраслей нельзя, пока их нет: строка
     про «сетевые клиники и B2B-каталоги» осталась от выдуманных кейсов и
     стояла над пустым списком. */
  "page.works.lead": "Здесь проекты, которые уже запущены и принимают заявки.",
